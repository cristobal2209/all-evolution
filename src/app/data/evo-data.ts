...
const ENGINE_OILS = {
  ...
  mobil1_fs_5w40: { brand: 'Mobil 1', product: 'FS European Car Formula 5W-40', viscosity: '5W-40', apiSpec: 'SP/SN', norms: ['API SP', 'ACEA A3/B4', 'BMW LL-01', 'MB 229.5', 'PORSCHE A40'], daily: 'high' as const, trackDay: 'high' as const, fullRacing: 'medium' as const },
  mobil1_fs_x2_5w50: { brand: 'Mobil 1', product: 'FS X2 5W-50', viscosity: '5W-50', apiSpec: 'SP', norms: ['API SP', 'ACEA A3/B4', 'MB 229.3'], daily: 'medium' as const, trackDay: 'high' as const, fullRacing: 'medium' as const },
  redline_5w50: { brand: 'Red Line', product: '5W-50', viscosity: '5W-50', apiSpec: 'SN/SM', norms: ['API SN', 'ACEA A3/B4'], daily: 'medium' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  redline_10w50: { brand: 'Red Line', product: '10W-50', viscosity: '10W-50', apiSpec: 'SN/SM', norms: ['API SN', 'ACEA A3/B4'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  redline_15w50: { brand: 'Red Line', product: '15W-50', viscosity: '15W-50', apiSpec: 'SN/SM', norms: ['API SN', 'ACEA A3/B4'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  redline_20w50: { brand: 'Red Line', product: '20W-50', viscosity: '20W-50', apiSpec: 'SN/SM', norms: ['API SN', 'ACEA A3'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  redline_10w60: { brand: 'Red Line', product: '10W-60', viscosity: '10W-60', apiSpec: 'SN/SM', norms: ['API SN', 'ACEA A3/B4'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  amsoil_dom_15w50: { brand: 'Amsoil', product: 'Dominator 15W-50', viscosity: '15W-50', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'Sin homologación API'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  motul_300v_comp_15w50: { brand: 'Motul', product: '300V Competition 15W-50', viscosity: '15W-50', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'ESTER Core'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  motul_300v_lemans_10w60: { brand: 'Motul', product: '300V Le Mans 10W-60', viscosity: '10W-60', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'ESTER Core'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  motul_300v_lemans_20w60: { brand: 'Motul', product: '300V Le Mans 20W-60', viscosity: '20W-60', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'ESTER Core'], daily: 'low' as const, trackDay: 'medium' as const, fullRacing: 'high' as const },
  liquimoly_gt1_10w60: { brand: 'Liqui Moly', product: 'Synthoil Race Tech GT1 10W-60', viscosity: '10W-60', apiSpec: 'SN/A3B4', norms: ['API SN', 'ACEA A3/B4'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  ravenol_rss_10w60: { brand: 'Ravenol', product: 'RSS Racing Sport Synto 10W-60', viscosity: '10W-60', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'USVO Technology'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  mobil1_fs_0w40: { brand: 'Mobil 1', product: 'FS European Car Formula 0W-40', viscosity: '0W-40', apiSpec: 'SP/SN', norms: ['API SP', 'ACEA A3/B4', 'MB 229.5', 'PORSCHE A40', 'BMW LL-01'], daily: 'high' as const, trackDay: 'high' as const, fullRacing: 'medium' as const },
  hks_str_5w40: { brand: 'HKS', product: 'Super Turbo Racing 5W-40', viscosity: '5W-40', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'Protección LSPI', 'Listado para 4G63/4B11'], daily: 'medium' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  hks_str_15w50: { brand: 'HKS', product: 'Super Turbo Racing 15W-50', viscosity: '15W-50', apiSpec: 'Racing (sin API)', norms: ['Uso racing', 'Protección LSPI'], daily: 'low' as const, trackDay: 'high' as const, fullRacing: 'high' as const },
  hks_premium_10w40: { brand: 'HKS', product: 'Super Oil Premium 10W-40', viscosity: '10W-40', apiSpec: 'SP', norms: ['API SP', 'Protección LSPI'], daily: 'high' as const, trackDay: 'medium' as const, fullRacing: 'low' as const },
  hks_premium_euro_5w40: { brand: 'HKS', product: 'Super Oil Premium EURO 5W-40', viscosity: '5W-40', apiSpec: 'SN/A3B4', norms: ['API SN', 'ACEA A3/B4'], daily: 'high' as const, trackDay: 'medium' as const, fullRacing: 'low' as const },
};
